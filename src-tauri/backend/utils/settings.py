...
class Settings:
    ...
    custom_mouse_speed: float = float(dictor(_data, "configuration.mouseSpeed", 0.1))
    ...
    enable_auto_quick_summon: bool = dictor(_data, "configuration.enableAutoQuickSummon", True)
    ...
    def update(setpath):
        ...
        Settings.custom_mouse_speed: float = float(dictor(_data, "configuration.mouseSpeed", 0.1))
        ...
        Settings.enable_auto_quick_summon: bool = dictor(_data, "configuration.enableAutoQuickSummon", True)
